...
<div class="row justify-content-center">
    <div class="col-lg-11">
        <div class="d-flex align-items-center mb-4">
            <a href="{{ route('pembayaran.index') }}" class="btn btn-light me-3">
                <i class="bi bi-arrow-left"></i>
            </a>
            <h3 class="fs-5 fw-semibold mb-0">Detail Pembayaran: {{ $pembayaran->kode_pembayaran }}</h3>
        </div>
                ...
                <div class="card h-100">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h5 class="fw-semibold mb-0">Informasi Transaksi</h5>
                            @php
                                $badges = [
                                    'menunggu' => 'bg-warning',
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td class="fw-semibold text-end">{{ $pembayaran->pesanan->user->name }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="fw-semibold text-end text-capitalize">{{ $pembayaran->metode_pembayaran }}</td>
                                </tr>
                                <tr>
                                    <td class="text-muted ps-0">Jenis</td>
                                    <td class="fw-semibold text-end text-capitalize">{{ $pembayaran->jenis_pembayaran }}</td>
                                </tr>
                                <tr class="border-top">
                                    <td class="text-muted ps-0 pt-3 fs-5">Jumlah Bayar</td>
                                    <td class="fw-semibold text-end pt-3 fs-4 text-primary">Rp {{ number_format($pembayaran->jumlah_bayar, 0, ',', '.') }}</td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="mt-5 pt-4 border-top">
                            <h6 class="fw-semibold mb-3">Tindakan Admin</h6>
            ...
            <div class="col-md-6">
                <div class="card h-100 overflow-hidden">
                    <div class="card-header bg-white border-0 py-3">
                        <h5 class="fw-semibold mb-0">Bukti Pembayaran</h5>
                    </div>
