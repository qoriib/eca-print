...
<div class="row justify-content-center">
    <div class="col-lg-10">
        <div class="d-flex align-items-center mb-4">
            ...
            <h3 class="fw-bold mb-0">Konfirmasi Pembayaran</h3>
        </div>
            ...
            <div class="col-md-5">
                <div class="card mb-4">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            <h6 class="fw-bold small text-uppercase text-muted">Transfer Bank (Manual)</h6>
                ...
                <div class="card">
                    <div class="card-body p-4 p-md-5">
                        <form action="{{ route('pembayaran.store', $pesanan) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <label for="jumlah_bayar" class="form-label fw-bold">Jumlah Yang Dibayar</label>
                                ...
                                <div class="col-md-6">
                                    <label for="metode_pembayaran" class="form-label fw-bold">Metode</label>
                                    <select name="metode_pembayaran" id="metode_pembayaran" class="form-select @error('metode_pembayaran') is-invalid @enderror" required>
                                        ...
                                        <option value="tunai" {{ old('metode_pembayaran') == 'tunai' ? 'selected' : '' }}>Tunai di Toko</option>
                                    </select>
                                ...
                                <div class="col-md-12">
                                    <label for="bukti_pembayaran" class="form-label fw-bold">Unggah Bukti Transfer</label>
                            ...
                            <div class="mt-5 d-grid">
                                <button type="submit" class="btn btn-primary btn-lg rounded-pill fw-bold">Kirim Konfirmasi Pembayaran</button>
                            </div>
                        </form>
                    </div>
                </div>
