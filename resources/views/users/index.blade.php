                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end pe-4">
                            <div class="btn-group">
                                <a href="{{ route('users.show', $user) }}" class="btn btn-sm btn-light rounded-circle me-1" title="Detail">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="{{ route('users.edit', $user) }}" class="btn btn-sm btn-light rounded-circle me-1" title="Edit">
                                        ...
                                        <div class="modal-body text-start">
                                            ...
                                            @if($user->pesanan()->count() > 0)
                                                <div class="alert alert-warning mt-2 py-2 small">
                                                    <i class="bi bi-exclamation-triangle me-1"></i> Pengguna ini memiliki data pesanan dan mungkin tidak dapat dihapus.
                                                </div>
                                            @endif
                                        </div>
