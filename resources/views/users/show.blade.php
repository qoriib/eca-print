    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="d-flex align-items-center mb-4">
                ...
                <h3 class="fs-5 fw-semibold mb-0">Detail Profil Pengguna</h3>
                <div class="ms-auto">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="card text-center p-4">
                        ...
                        <span
                            class="badge {{ $user->role === 'admin' ? 'bg-danger' : ($user->role === 'operator' ? 'bg-primary' : 'bg-success') }} px-4 py-2 text-capitalize fs-6">
                            {{ $user->role }}
                        </span>
                        <hr class="my-4">
                        <div class="text-start">
                            <div class="mb-3">
                                ...
                                <div class="fw-medium font-monospace">{{ $user->no_telepon ?? 'Tidak ada data' }}</div>
                            </div>
                            <div class="mb-0">
                                    ...
                                    <tbody>
                                        @forelse($user->pesanan as $pesanan)
                                            <tr class="text-nowrap">
                                                <td class="ps-4 fw-semibold font-monospace text-primary">{{ $pesanan->kode_pesanan }}</td>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5" class="text-center py-5 text-muted">Belum ada riwayat pesanan
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
