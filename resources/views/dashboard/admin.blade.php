    ...
    <div class="col-lg-8 mb-4">
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('pesanan.index') }}" class="btn btn-sm btn-outline-primary rounded-pill">Lihat Semua</a>
            </div>
        ...
        <div class="card border-0 shadow-sm rounded-4">
            ...
            <div class="card-body p-3">
                ...
                <div class="d-flex align-items-center mb-3 p-3 bg-light rounded-3 border">
                    ...
                    <a href="{{ route('pembayaran.show', $bayar) }}" class="btn btn-sm btn-primary rounded-pill px-3">Konfirmasi</a>
                </div>
                @empty
