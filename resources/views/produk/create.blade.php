                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control @error('nama_produk') is-invalid @enderror"
                                            ...
                                            placeholder="Contoh: Brosur A4 Art Paper">
                                        @error('nama_produk')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select @error('kategori_produk_id') is-invalid @enderror"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('satuan') is-invalid @enderror"
                                            ...
                                            placeholder="pcs, lembar, meter, dll">
                                        @error('satuan')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                                            ...
                                            placeholder="Jelaskan detail produk, spesifikasi, atau minimal order...">{{ old('deskripsi') }}</textarea>
                                        @error('deskripsi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4">
                            <div class="card-body p-4">
                                <label class="form-label d-block mb-3">Gambar Produk</label>
                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                <label class="form-label d-block mb-3">Pengaturan</label>
                                <div class="form-check form-switch mb-0">
                                    <input class="form-check-input" type="checkbox" role="switch" id="is_aktif"
                                        name="is_aktif" value="1" {{ old('is_aktif', true) ? 'checked' : '' }}>
                                    <label class="form-check-label fw-medium" for="is_aktif">Produk Aktif</label>
                                </div>
                                <small class="text-muted">Produk yang aktif akan muncul di katalog pesanan
                                    pelanggan.</small>
                            </div>
                        </div>
