                    ...
                    <div class="col-md-7">
                        <div class="card-body">
                                ...
                                <div class="text-muted">Status:
                                    ...
                                    @else
                                        <span class="text-danger fw-semibold"><i
                                                class="bi bi-x-circle-fill me-1"></i>Non-aktif</span>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="mb-4 bg-light p-3 rounded">
                                ...
                                <h3 class="fs-5 fw-semibold text-primary font-monospace mb-0">
                                    Rp {{ number_format($produk->harga_satuan, 0, ',', '.') }}
                                    <small class="text-muted fs-6 fw-normal">/ {{ $produk->satuan }}</small>
                                </h3>
                            </div>
                            ...
                            <div class="row g-3 pt-4 border-top">
                                <div class="col-sm-6">
                                    <div class="d-flex align-items-center">
                                        <div class="bg-primary-subtle py-2 px-3 rounded me-3 text-primary">
                                ...
                                <div class="col-sm-6">
                                    <div class="d-flex align-items-center">
                                        <div class="bg-info-subtle py-2 px-3 rounded me-3 text-info">
