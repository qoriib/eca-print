                ...
                <div class="card h-100 border-0 shadow-sm overflow-hidden position-relative stat-card">
                    ...
                    <div class="card-body">
                        <small class="text-primary fw-semibold text-uppercase"
                            style="font-size: 0.7rem;">{{ $item->kategoriProduk->nama_kategori }}</small>
                        <h5 class="fw-semibold mb-2 text-truncate" title="{{ $item->nama_produk }}">
                            {{ $item->nama_produk }}
                        </h5>
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="text-primary fw-medium font-monospace mb-0">
