        ...
        <form action="{{ route('pesanan.index') }}" method="GET" class="row g-3">
            <div class="col-md-4">
                <div class="input-group">
                    ...
                    <input type="text" name="search" class="form-control border-start-0 ps-0" placeholder="Cari Kode Pesanan (ECA-XXXX)..." value="{{ request('search') }}">
                </div>
            </div>
            <div class="col-md-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end pe-4">
                            <div class="btn-group">
                                <a href="{{ route('pesanan.show', $item) }}" class="btn btn-sm btn-light rounded-circle me-1" title="Detail">
                                    <i class="bi bi-eye"></i>
                                </a>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content border-0 shadow">
                                        ...
                                        <div class="modal-body text-start">
                                            Apakah Anda yakin ingin menghapus pesanan <strong>{{ $item->kode_pesanan }}</strong>?
                                            <div class="alert alert-warning mt-2 py-2 small border-0">
                                                <i class="bi bi-exclamation-triangle me-1"></i> Data yang sudah dihapus tidak dapat dikembalikan.
                                            </div>
                                        </div>
                    ...
                    @empty
                    <tr>
                        <td colspan="{{ Auth::user()->role !== 'pelanggan' ? 6 : 5 }}" class="text-center py-5 text-muted">
