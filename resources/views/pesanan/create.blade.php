    ...
    <div class="row justify-content-center">
        <div class="col-lg-11">
            <div class="d-flex align-items-center mb-4">
                <a href="{{ route('pesanan.index') }}" class="btn btn-light me-3">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                <input type="number" name="items[0][jumlah]" class="form-control item-qty"
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input type="text" name="items[0][ukuran]" class="form-control"
                                                placeholder="Contoh: A4, 2x3 meter, 9x5 cm">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label small">Bahan (Opsional)</label>
                                            <input type="text" name="items[0][bahan]" class="form-control"
                                                placeholder="Contoh: Art Paper 260gr, Flexy 280gr">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label small">Finishing (Opsional)</label>
                                            <input type="text" name="items[0][finishing]" class="form-control"
                                                placeholder="Contoh: Laminating Glossy, Mata Ayam">
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label small">Upload Desain (Opsional)</label>
                                            <input type="file" name="items[0][file_desain]" class="form-control"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea name="items[0][keterangan]" class="form-control" rows="2"
                        ...
                        <div class="sticky-top" style="top: 2rem; z-index: 1;">
                            <div class="card mb-4">
                                <div class="card-body p-4">
                                    ...
                                    <div class="mb-4">
                                        <label for="tanggal_deadline" class="form-label small">Tanggal Deadline (Harapan
                                            Selesai)</label>
                                    ...
                                    <div class="mb-4">
                                        <label for="catatan_pelanggan" class="form-label small">Catatan Pesanan
                                            (Global)</label>
                                        <textarea name="catatan_pelanggan" id="catatan_pelanggan" class="form-control"
                                    ...
                                    <div class="bg-light p-3 rounded mb-4">
                                        ...
                                        <small class="text-muted d-block text-center mt-2" style="font-size: 0.7rem;">*Harga
                                            final akan dikonfirmasi oleh Admin.</small>
                                    </div>
                            ...
                            <div class="card border-0 bg-primary-subtle text-primary">
                                <div class="card-body p-4">
                                    <div class="d-flex">
                                        ...
                                        <small>Setelah membuat pesanan, silakan tunggu konfirmasi Admin untuk melakukan
                                            pembayaran.</small>
                                    </div>
                                </div>
                            </div>
