    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="alert alert-info border-0 shadow-sm mb-4">
                <i class="bi bi-info-circle-fill me-2"></i> Anda hanya dapat mengubah informasi dasar pesanan. Untuk
                mengubah daftar item cetakan, silakan hubungi admin atau buat pesanan baru.
            </div>
                    ...
                    <form action="{{ route('pesanan.update', $pesanan) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="catatan_pelanggan" id="catatan_pelanggan" class="form-control"
                                rows="4">{{ old('catatan_pelanggan', $pesanan->catatan_pelanggan) }}</textarea>
                        </div>
