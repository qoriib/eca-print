...
@section('content')
    <div class="d-flex align-items-center mb-4">
        ...
        <h3 class="fs-5 fw-semibold mb-0">Detail Item Pesanan: {{ $pesanan->kode_pesanan }}</h3>
    </div>
                    ...
                    <tbody>
                        @foreach($pesanan->detailPesanan as $detail)
                            <tr>
                                ...
                                <td>{{ $detail->ukuran ?? '-' }}</td>
                                <td>{{ $detail->bahan ?? '-' }}</td>
                                <td class="font-monospace">{{ $detail->finishing ?? '-' }}</td>
                                <td class="font-monospace">{{ $detail->jumlah }} {{ $detail->produk->satuan }}</td>
                                <td>
