...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3 class="fs-5 fw-semibold">Kategori Produk</h3>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end pe-4">
                            <div class="btn-group">
                                <a href="{{ route('kategori-produk.show', $item) }}" class="btn btn-sm btn-light rounded-circle me-1" title="Detail">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="{{ route('kategori-produk.edit', $item) }}" class="btn btn-sm btn-light rounded-circle me-1" title="Edit">
                                        ...
                                        <div class="modal-body text-start">
                                            ...
                                            @if($item->produk_count > 0)
                                                <div class="alert alert-danger mt-2 py-2 small border-0">
                                                    <i class="bi bi-exclamation-octagon me-1"></i> Kategori ini tidak dapat dihapus karena masih memiliki <strong>{{ $item->produk_count }} produk</strong>.
                                                </div>
                                            @endif
                                        </div>
