    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="d-flex align-items-center mb-4">
                ...
                <h3 class="fs-5 fw-semibold mb-0">Detail Kategori: {{ $kategoriProduk->nama_kategori }}</h3>
                <div class="ms-auto">
                ...
                <div class="col-md-4">
                    <div class="card p-4">
                        ...
                        <div class="mb-0 pt-3 border-top">
                            ...
                            <h3 class="fs-5 fw-semibold mb-0">{{ $kategoriProduk->produk->count() }}</h3>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                <td class="ps-4">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        @endif
                                                        <div class="fw-medium">{{ $produk->nama_produk }}</div>
                                                    </div>
                                                </td>
                                                <td class="font-monospace">
                                                    Rp {{ number_format($produk->harga_satuan, 0, ',', '.') }}/{{ $produk->satuan }}
                                                </td>
                                                <td>
                                                    @if($produk->is_aktif)
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="4" class="text-center py-5 text-muted">Belum ada produk dalam
                                                    kategori ini</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
